                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              name,
                              style: TakoTheme.darkTextTheme.headline3!.copyWith(fontSize: 18.0),
                              maxLines: 2,
                            ),
                          ),
                          Padding(
                            ...
                            child: Text(
                              currentEp,
                              style: TakoTheme.darkTextTheme.subtitle2!.copyWith(color: const Color(0xFF58E6DE), fontSize: 16, fontWeight: FontWeight.w600),
                            ),
                          ),
                        ],
                      ),
