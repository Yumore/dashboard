        ...
        children: [
          Expanded(
              child: FutureBuilder<AnimeResults>(
                  future: AnimeService().getAnimes(provider.requestAnimeGenre(genre.link, _pageIndex)),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return AnimatedBuilder(
                            ...
                            builder: (BuildContext context, Widget? child) {
                              return Transform(
                                transform: Matrix4.translationValues(0, 100 * (1.0 - TakoCurveAnimation(animationController, index, list.length).value), 0),
                                child: child,
                              );
                            },
                          );
