    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Center(child: OrientationBuilder(builder: (context, orientation) {
          ...
          return AspectRatio(
            aspectRatio: orientation == Orientation.landscape ? 16 / 9 : 4 / 2.885,
            child: Stack(
              fit: StackFit.expand,
              children: [
                SizedBox.fromSize(
                  ...
                  child: TakoPlayWebView(
                    ...
                    onLoadingFinished: (_webViewController) async {
                      try {
                        ...
                        await _webViewController.runJavascriptReturningResult("document.getElementsByClassName('jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-fullscreen')[1].click();");
