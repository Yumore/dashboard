...
class _ReaderMenuState extends State<ReaderMenu> with SingleTickerProviderStateMixin {
  ...
  buildTopView(BuildContext context) {
    return Positioned(
      top: -ScreenUtils.navigationBarHeight * (1 - animation.value),
      left: 0,
      right: 0,
      child: Container(
        decoration: BoxDecoration(color: SQColor.paper, boxShadow: Styles.borderShadow),
        height: ScreenUtils.navigationBarHeight,
        padding: EdgeInsets.fromLTRB(5, ScreenUtils.topSafeHeight, 5, 0),
        child: Row(
          children: <Widget>[
            Container(
              width: 44,
  ...
  buildBottomView() {
    return Positioned(
      bottom: -(ScreenUtils.bottomSafeHeight + 110) * (1 - animation.value),
      left: 0,
      right: 0,
      child: Column(
        children: <Widget>[
