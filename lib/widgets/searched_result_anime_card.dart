                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Tooltip(
                          message: anime.name.toString().isCaseInsensitiveContains('dub') ? 'Dub' : 'Sub',
                          triggerMode: TooltipTriggerMode.tap,
                          child: Icon(Icons.album_rounded, size: 25, color: anime.name.toString().isCaseInsensitiveContains('dub') ? Colors.orange : Color.fromARGB(255, 212, 0, 99)),
                        ),
                      ),
                    ),
                  ],
