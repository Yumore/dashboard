import 'package:admin/screens/tako/recent_list_screen.dart';
        ...
        () => BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              icon: Icon(currentIndex.value == 0 ? Icons.home_filled : Icons.home_outlined),
              label: 'Home',
            ),
            BottomNavigationBarItem(
              icon: Icon(currentIndex.value == 1 ? Icons.access_time_filled : Icons.access_time_outlined),
              label: 'Recent',
            ),
            BottomNavigationBarItem(
              icon: Icon(currentIndex.value == 2 ? Icons.bookmark : Icons.bookmark_outline),
              label: 'BookMarks',
            ),
          ],
        ),
