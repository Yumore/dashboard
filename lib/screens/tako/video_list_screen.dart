...
import '../../utility/tako_helper.dart';
...
class _VideoListScreenState extends State<VideoListScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    animationController = AnimationController(duration: Duration(milliseconds: takoAnimationDuration), vsync: this);
        ...
        body: FutureBuilder<Anime>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.connectionState == ConnectionState.done) {
                ...
                epChunkList.value = anime.episodes!.sublist(0, (hasRemainingEp == true && anime.episodes!.length < 50) ? remainingEp : 50);
                                      ...
                                      builder: (_) => TextButton.icon(
                                          onPressed: () {
                                            ...
                                            if (bookMarkManager.ids.contains(anime.id.toString())) {
                                              ...
                                              //Removed
                                              Get.snackbar(name, 'Removed from bookmark successfully!',
                                              ...
                                              //Add
                                              Get.snackbar(name, 'Added to bookmark successfully!',
                                                  backgroundColor: Colors.black38, duration: const Duration(milliseconds: 1300), snackPosition: SnackPosition.BOTTOM);
                                            }
                                          },
                                          icon: Icon(
                                            bookMarkManager.ids.contains(anime.id) ? Icons.bookmark : Icons.bookmark_border_outlined,
                                            color: Colors.white,
                                          ),
                                          label: Text(
                                            'BookMark',
                                            style: TakoTheme.darkTextTheme.bodyText1!.copyWith(color: Colors.white),
                                          )),
                                    )
                                  ],
                                ),
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                ...
                                                if (finalChipCount == (index + 1)) {
                                                  ...
                                                  epChunkList.value = anime.episodes!.sublist(int.parse(start) - 1, int.parse(end));
                                                }
                                              },
                                              child: Obx(
                                                () => Chip(
                                                  backgroundColor: selectedChipIndex.value == index ? tkGradientBlue : Color.fromARGB(255, 19, 18, 18).withOpacity(.8),
                                                  padding: EdgeInsets.symmetric(horizontal: 10),
                                                  label: Text(getEpisodeRange(index), style: TakoTheme.darkTextTheme.subtitle1!),
                                                ),
                                              ),
                                            ),
                                          );
                                          ...
                                          return Obx(
                                            () => AnimatedBuilder(
                                              ...
                                              child: Material(
                                                ...
                                                color: selectedIndex.value == index ? tkGradientBlue : Colors.white,
                                                child: InkWell(
                                                  borderRadius: BorderRadius.circular(10),
                                                  onTap: () async {
                                                    ...
                                                    await Get.toNamed(Routes.mediaFetchScreen, arguments: {'animeUrl': epChunkList[index].link.toString()});
                                                  },
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: TakoTheme.darkTextTheme.headline6!.copyWith(color: selectedIndex.value == index ? Colors.white : Colors.black),
                                                    ),
                                                  ),
                                                ),
                                              ),
                                              builder: (context, child) {
                                                return Transform(
                                                  transform: Matrix4.translationValues(0, 100 * (1.0 - TakoCurveAnimation(animationController, index, epChunkList.length).value), 0),
                                                  child: child,
                                                );
                                              },
                                            ),
