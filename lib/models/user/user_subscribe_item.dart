...
class SubscribeItem {
  ...
  SubscribeItem({
    ...
    String? status,
        ...
        _sub_update = sub_update!,
        _sub_img = sub_img!,
        _sub_uptime = sub_uptime!,
        _sub_first_letter = sub_first_letter!,
        _sub_readed = sub_readed!,
        _id = id!,
        _status = status!;

  factory SubscribeItem.fromJson(jsonRes) => SubscribeItem(
        name: jsonRes['name'],
