...
class ComicDetailV2Model {
  ...
  factory ComicDetailV2Model.fromJson(Map<String, dynamic> jsonRes) {
    final List<ComicDetailV2AuthorModel>? authors = jsonRes['authors'] is List ? <ComicDetailV2AuthorModel>[] : null;
    if (authors != null) {
      for (final dynamic item in jsonRes['authors']) {
        if (item != null) {
          authors.add(ComicDetailV2AuthorModel.fromJson(asT<Map<String, dynamic>>(item)));
        }
      }
    }

    final List<ComicDetailV2TagModel>? tags = jsonRes['tags'] is List ? <ComicDetailV2TagModel>[] : null;
    if (tags != null) {
      for (final dynamic item in jsonRes['tags']) {
        if (item != null) {
          tags.add(ComicDetailV2TagModel.fromJson(asT<Map<String, dynamic>>(item)));
        }
      }
    }

    final List<ComicDetailV2VolumeModel>? volume = jsonRes['volume'] is List ? <ComicDetailV2VolumeModel>[] : null;
    if (volume != null) {
      for (final dynamic item in jsonRes['volume']) {
        if (item != null) {
          volume.add(ComicDetailV2VolumeModel.fromJson(asT<Map<String, dynamic>>(item)));
        }
      }
    }
...
class ComicDetailV2AuthorModel {
  ...
  factory ComicDetailV2AuthorModel.fromJson(Map<String, dynamic> jsonRes) => ComicDetailV2AuthorModel(
...
class ComicDetailV2TagModel {
  ...
  factory ComicDetailV2TagModel.fromJson(Map<String, dynamic> jsonRes) => ComicDetailV2TagModel(
...
class ComicDetailV2VolumeModel {
  ...
  factory ComicDetailV2VolumeModel.fromJson(Map<String, dynamic> jsonRes) {
    final List<ComicDetailV2VolumeChapterModel>? chapters = jsonRes['chapters'] is List ? <ComicDetailV2VolumeChapterModel>[] : null;
    if (chapters != null) {
      for (final dynamic item in jsonRes['chapters']) {
        if (item != null) {
          chapters.add(ComicDetailV2VolumeChapterModel.fromJson(asT<Map<String, dynamic>>(item)));
        }
      }
    }
...
class ComicDetailV2VolumeChapterModel {
  ...
  factory ComicDetailV2VolumeChapterModel.fromJson(Map<String, dynamic> jsonRes) => ComicDetailV2VolumeChapterModel(
