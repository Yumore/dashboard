...
class NovelDetail {
  ...
  NovelDetail({
    ...
    List<NovelDetailVolumeItem>? volume,
        ...
        _redis_update_time = redis_update_time!,
        _volume = volume!;

  factory NovelDetail.fromJson(jsonRes) {
    ...
    if (volume != null) {
      for (var item in jsonRes['volume']) {
        if (item != null) {
          volume.add(NovelDetailVolumeItem.fromJson(item));
        }
      }
    }
...
class NovelDetailVolumeItem {
  ...
  NovelDetailVolumeItem({
    ...
    int? sum_chapters,
        ...
        _lnovel_id = lnovel_id!,
        _volume_name = volume_name!,
        _volume_order = volume_order!,
        _addtime = addtime!,
        _sum_chapters = sum_chapters!;

  factory NovelDetailVolumeItem.fromJson(jsonRes) => NovelDetailVolumeItem(
        id: jsonRes['id'],
