...
import 'package:dashboard/models/comic/comic_history_item.dart';
import 'package:dashboard/models/novel/novel_history_item.dart';
...
class _HistoryTabItemState extends State<HistoryTabItem> with AutomaticKeepAliveClientMixin {
  @override
              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("看到" + item.chapter_name, style: TextStyle(color: Colors.grey, fontSize: 14)),
                    SizedBox(
                      height: 2,
                    ),
