...
class ComicDetailResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicDetailResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.comic'), createEmptyInstance: create)
  ...
  ComicDetailResponse copyWith(void Function(ComicDetailResponse) updates) =>
      super.copyWith((message) => updates(message as ComicDetailResponse)) as ComicDetailResponse; // ignore: deprecated_member_use
...
class ComicDetailInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicDetailInfoResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.comic'), createEmptyInstance: create)
    ...
    ..pc<ComicDetailTypeItemResponse>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Types', $pb.PbFieldType.PM,
        protoName: 'Types', subBuilder: ComicDetailTypeItemResponse.create)
    ..pc<ComicDetailTypeItemResponse>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Status', $pb.PbFieldType.PM,
        protoName: 'Status', subBuilder: ComicDetailTypeItemResponse.create)
    ..pc<ComicDetailTypeItemResponse>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Authors', $pb.PbFieldType.PM,
    ...
    ..pc<ComicDetailChapterResponse>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Chapters', $pb.PbFieldType.PM,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ComicDetailInfoResponse copyWith(void Function(ComicDetailInfoResponse) updates) =>
      super.copyWith((message) => updates(message as ComicDetailInfoResponse)) as ComicDetailInfoResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
...
class ComicDetailTypeItemResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicDetailTypeItemResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.comic'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ComicDetailTypeItemResponse copyWith(void Function(ComicDetailTypeItemResponse) updates) =>
      super.copyWith((message) => updates(message as ComicDetailTypeItemResponse)) as ComicDetailTypeItemResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
...
class ComicDetailChapterResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicDetailChapterResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.comic'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Title', protoName: 'Title')
    ..pc<ComicDetailChapterInfoResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Data', $pb.PbFieldType.PM,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ComicDetailChapterResponse copyWith(void Function(ComicDetailChapterResponse) updates) =>
      super.copyWith((message) => updates(message as ComicDetailChapterResponse)) as ComicDetailChapterResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
...
class ComicDetailChapterInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicDetailChapterInfoResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.comic'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ComicDetailChapterInfoResponse copyWith(void Function(ComicDetailChapterInfoResponse) updates) =>
      super.copyWith((message) => updates(message as ComicDetailChapterInfoResponse)) as ComicDetailChapterInfoResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
