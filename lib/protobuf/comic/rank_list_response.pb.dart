...
class ComicRankListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicRankListResponse',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ComicRankListResponse copyWith(void Function(ComicRankListResponse) updates) =>
      super.copyWith((message) => updates(message as ComicRankListResponse)) as ComicRankListResponse; // ignore: deprecated_member_use
...
class ComicRankListItemResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicRankListItemResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.comic'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ComicRankListItemResponse copyWith(void Function(ComicRankListItemResponse) updates) =>
      super.copyWith((message) => updates(message as ComicRankListItemResponse)) as ComicRankListItemResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
