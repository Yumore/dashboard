...
class ComicUpdateListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicUpdateListResponse',
    ...
    ..pc<ComicUpdateListItemResponse>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Data', $pb.PbFieldType.PM,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ComicUpdateListResponse copyWith(void Function(ComicUpdateListResponse) updates) =>
      super.copyWith((message) => updates(message as ComicUpdateListResponse)) as ComicUpdateListResponse; // ignore: deprecated_member_use
...
class ComicUpdateListItemResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComicUpdateListItemResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.comic'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ComicUpdateListItemResponse copyWith(void Function(ComicUpdateListItemResponse) updates) =>
      super.copyWith((message) => updates(message as ComicUpdateListItemResponse)) as ComicUpdateListItemResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
