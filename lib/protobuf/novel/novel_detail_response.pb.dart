...
class NovelDetailResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NovelDetailResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.novel'), createEmptyInstance: create)
  ...
  NovelDetailResponse copyWith(void Function(NovelDetailResponse) updates) =>
      super.copyWith((message) => updates(message as NovelDetailResponse)) as NovelDetailResponse; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set data(NovelDetailInfoResponse v) {
    setField(3, v);
  }
...
class NovelDetailInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NovelDetailInfoResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.novel'), createEmptyInstance: create)
    ...
    ..pc<NovelDetailInfoVolumeResponse>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Volume', $pb.PbFieldType.PM,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  NovelDetailInfoResponse copyWith(void Function(NovelDetailInfoResponse) updates) =>
      super.copyWith((message) => updates(message as NovelDetailInfoResponse)) as NovelDetailInfoResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  ...
  @$pb.TagNumber(7)
  set lastUpdateVolumeId($core.int v) {
    $_setSignedInt32(6, v);
  }
...
class NovelDetailInfoVolumeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NovelDetailInfoVolumeResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.novel'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  NovelDetailInfoVolumeResponse copyWith(void Function(NovelDetailInfoVolumeResponse) updates) =>
      super.copyWith((message) => updates(message as NovelDetailInfoVolumeResponse)) as NovelDetailInfoVolumeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
