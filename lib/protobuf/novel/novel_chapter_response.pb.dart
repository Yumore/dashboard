...
class NovelChapterResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NovelChapterResponse',
    ...
    ..pc<NovelChapterVolumeResponse>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Data', $pb.PbFieldType.PM,
  ...
  NovelChapterResponse copyWith(void Function(NovelChapterResponse) updates) =>
      super.copyWith((message) => updates(message as NovelChapterResponse)) as NovelChapterResponse; // ignore: deprecated_member_use
...
class NovelChapterVolumeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NovelChapterVolumeResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.novel'), createEmptyInstance: create)
    ...
    ..pc<NovelChapterItemResponse>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Chapters', $pb.PbFieldType.PM,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  NovelChapterVolumeResponse copyWith(void Function(NovelChapterVolumeResponse) updates) =>
      super.copyWith((message) => updates(message as NovelChapterVolumeResponse)) as NovelChapterVolumeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
...
class NovelChapterItemResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NovelChapterItemResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'dmzj.novel'), createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  NovelChapterItemResponse copyWith(void Function(NovelChapterItemResponse) updates) =>
      super.copyWith((message) => updates(message as NovelChapterItemResponse)) as NovelChapterItemResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
