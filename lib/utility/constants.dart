...
const String latestRelease = 'https://api.github.com/repos/kaungsatthe1n/Tako-Play/releases/latest';

const String baseUrl = 'https://gogoanime.wiki/';
const String search = '/search.html?keyword=';
final mediaFileRegExp = RegExp(r"(https)://[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+[.m3u8]");
...
const String mailing = 'mailto:parrotksh@gmail.com?subject=[TakoPlay: (Ver: $version)]';
