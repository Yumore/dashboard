...
class ComicHomeListData {
  ...
  ComicHomeListData.fromJson(Map<String, dynamic> json) {
    if (json['book'] != null) {
      book = new List<ComicHomeListDataBook>();
      (json['book'] as List).forEach((v) {
        book.add(new ComicHomeListDataBook.fromJson(v));
      });
    }
    name = json['name'];
  }
...
class ComicHomeListDataBook {
  ...
  ComicHomeListDataBook.fromJson(Map<String, dynamic> json) {
    ...
    if (json['comic_info'] != null) {
      comicInfo = new List<ComicHomeListDataBookComicInfo>();
      (json['comic_info'] as List).forEach((v) {
        comicInfo.add(new ComicHomeListDataBookComicInfo.fromJson(v));
      });
    }
...
class ComicHomeListDataBookComicInfo {
  ...
  ComicHomeListDataBookComicInfo(
      {this.comicName, this.comicId, this.score, this.updateTime, this.totalViewNum, this.imgUrl, this.pingfen, this.lastComicChapterName, this.ordernum, this.comicType, this.content, this.url});
