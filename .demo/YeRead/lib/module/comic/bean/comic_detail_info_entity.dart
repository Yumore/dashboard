class ComicDetailInfoEntity {
  ...
  ComicDetailInfoEntity.fromJson(Map<String, dynamic> json) {
    ...
    if (json['comic_chapter'] != null) {
      comicChapter = new List<ComicDetailInfoComicChapter>();
      (json['comic_chapter'] as List).forEach((v) {
        comicChapter.add(new ComicDetailInfoComicChapter.fromJson(v));
      });
    }
    ...
    if (json['comic_type_new'] != null) {
      comicTypeNew = new List<ComicDetailInfoComicTypeNew>();
      (json['comic_type_new'] as List).forEach((v) {
        comicTypeNew.add(new ComicDetailInfoComicTypeNew.fromJson(v));
      });
    }
