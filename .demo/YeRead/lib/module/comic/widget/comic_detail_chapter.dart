...
class ComicDetailChapter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (comicChapter == null || CollectionsUtils.isEmpty(comicChapter.comicChapter)) {
      return Container();
    }
    ...
    return SingleChildScrollView(
        child: Column(
          children: <Widget>[
            Container(
                child: Text("章节目录：", style: TextStyle(fontSize: 12, color: TYColor.gray, fontWeight: FontWeight.w300, decoration: TextDecoration.none)), padding: EdgeInsets.fromLTRB(15, 10, 10, 0)),
            GridView(
                padding: EdgeInsets.fromLTRB(15, 10, 15, 10),
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(mainAxisSpacing: 10, crossAxisSpacing: 15, crossAxisCount: 3, childAspectRatio: 2.4),
            ...
            GestureDetector(
              ...
              child: Container(
                  ...
                  alignment: Alignment.center,
                  child: Text("全部章节", style: TextStyle(fontSize: 17, color: TYColor.mediumGray, fontWeight: FontWeight.w300, decoration: TextDecoration.none))),
            ),
          ],
