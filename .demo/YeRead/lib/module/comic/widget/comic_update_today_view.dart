...
import 'package:tianyue/module/comic/widget/comic_update_today_item_view.dart';
...
class ComicUpdateTodayView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var children = updateTodayList.map((comicItem) => ComicUpdateTodayItemView(comicItem)).toList();
    return Container(
      color: TYColor.white,
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              ...
              Container(
                child: Wrap(spacing: 15, runSpacing: 0, direction: Axis.vertical, children: children),
              ),
            ],
          ),
        ],
