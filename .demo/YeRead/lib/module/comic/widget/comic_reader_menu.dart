...
class ComicReaderMenu extends StatefulWidget {
  ...
  final void Function(ComicDetailInfoComicChapter chapter, int index) onToggleChapter;

  ComicReaderMenu({this.chapters, this.articleIndex, this.onTap, this.onPreviousArticle, this.onNextArticle, this.onToggleChapter});

  @override
  _ComicReaderMenuState createState() => _ComicReaderMenuState();
}

class _ComicReaderMenuState extends State<ComicReaderMenu> with SingleTickerProviderStateMixin {
...
//    });
            ...
            Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return buildChapterWidget(context, widget.chapters[index], index);
                  }),
            )
          ],
        ),
  ...
  Widget buildChapterWidget(BuildContext context, ComicDetailInfoComicChapter chapterName, int index) {
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Text(chapterName.chapterName, style: TextStyle(fontSize: 17, color: TYColor.gray, fontWeight: FontWeight.w500, decoration: TextDecoration.none))));
  }
  ...
  buildProgressTipView() {
    ...
    ComicDetailInfoComicChapter chapter = this.widget.chapters[currentArticleIndex()];
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(chapter.chapterName, style: TextStyle(color: Colors.white, fontSize: 16)),
