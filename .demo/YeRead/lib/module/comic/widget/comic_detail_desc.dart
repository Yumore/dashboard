...
class ComicDetailDesc extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (comicDetail == null || CollectionsUtils.isEmpty(comicDetail.comicChapter)) {
      return Container();
    }
    ...
    return SingleChildScrollView(
        child: Column(
          children: <Widget>[
            Container(
                child: Text(comicDetail.comicDesc, style: TextStyle(fontSize: 14, color: TYColor.mediumGray, fontWeight: FontWeight.w300, decoration: TextDecoration.none)),
