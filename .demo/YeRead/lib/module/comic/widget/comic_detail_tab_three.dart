      ...
      Row(
        children: <Widget>[
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
            Text(comment.userName, style: TextStyle(fontSize: 14, color: Color(0xffe86a3e), fontWeight: FontWeight.w500, decoration: TextDecoration.none)),
            Text(comment.time, style: TextStyle(fontSize: 12, color: TYColor.gray, fontWeight: FontWeight.w300, decoration: TextDecoration.none)),
          ]),
        ],
      ),
      Container(
          ...
          child: Text(comment.content, style: TextStyle(fontSize: 16, color: TYColor.darkGray, fontWeight: FontWeight.w300, decoration: TextDecoration.none))),
      Container(
        height: 0.8,
        width: width,
