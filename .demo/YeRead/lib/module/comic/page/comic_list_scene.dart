...
class ComicMenuListState extends State<ComicMenuListScene> with AutomaticKeepAliveClientMixin {
  @override
  ...
  List<Widget> getListView() {
    ...
    var children = blocks.map((comicItem) => DmRankItemView(comicItem, TYColor.white)).toList();
    return children;
  }
