      ...
      children: <Widget>[
        ...
        Opacity(
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                new StoreConnector<AppState, AppState>(builder: (BuildContext context, AppState state) {
                  //使用全局状态管理，获取用户的状态信息
                  return GestureDetector(
                      ...
                      child: CircleAvatar(
                        backgroundImage: AssetImage(state.role.isBoy ? 'img/ic_user_icon.png' : 'img/ic_user_icon_woman.png'),
                      ));
                ...
                Expanded(
                  child: Text(
                    '腾讯动漫',
                    style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: TYColor.primary),
