        ...
        children: <Widget>[
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                Text(info.book.title, style: TextStyle(fontSize: fixedFontSize(18), color: TYColor.darkGray, fontWeight: FontWeight.bold)),
                SizedBox(height: 10),
                Text(info.book.author, style: TextStyle(fontSize: fixedFontSize(14), color: TYColor.darkGray)),
                SizedBox(height: 10),
                SizedBox(height: 10),
                SizedBox(height: 10),
              ],
