    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            NovelCoverImage("http://statics.zhuishushenqi.com" + comicItem.cover, width: width, height: width / 0.75),
            SizedBox(
              width: 10,
            ),
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(fontSize: 12, color: TYColor.gray, decoration: TextDecoration.none),
                    maxLines: 2,
                  ),
                  SizedBox(
                    height: 10,
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Text(
                        comicItem.author,
                        style: TextStyle(fontSize: 12, color: TYColor.darkGray, decoration: TextDecoration.none),
                        maxLines: 1,
                      ),
                      Expanded(
                        child: Container(),
