 ...
 * 小说阅读菜单界面
 */
class NovelReaderMenu extends StatefulWidget {
  ...
  NovelReaderMenu({this.chapters, this.articleIndex, this.onTap, this.onPreviousArticle, this.onNextArticle, this.onToggleChapter});

  @override
  _NovelReaderMenuState createState() => _NovelReaderMenuState();
}

class _NovelReaderMenuState extends State<NovelReaderMenu> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(NovelReaderMenu oldWidget) {
