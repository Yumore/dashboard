class NovelSearchHotwordEntity {
  ...
  NovelSearchHotwordEntity.fromJson(Map<String, dynamic> json) {
    if (json['searchHotWords'] != null) {
      searchHotWords = new List<NovelSearchHotwordSearchhotword>();
      (json['searchHotWords'] as List).forEach((v) {
        searchHotWords.add(new NovelSearchHotwordSearchhotword.fromJson(v));
      });
    }
    ok = json['ok'];
  }
