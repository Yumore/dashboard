...
class NovelPost {
  ...
  NovelPost(
      {this.author, this.created, this.book, this.likeCount, this.type, this.title, this.content, this.commentCount, this.block, this.sId, this.state, this.voteCount, this.haveImage, this.updated});
