...
class NovelFindSceneState extends State<NovelFindScene> with SingleTickerProviderStateMixin {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Container(height: 40, alignment: Alignment.center, padding: EdgeInsets.symmetric(horizontal: 15), child: Text("发现")),
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              FlatButton.icon(
                  // 文本内容
                  icon: Image.asset(
                    "img/discover_icon_classify.png",
                    width: 40,
                    height: 40,
                  ),
              ...
              FlatButton.icon(
                  // 文本内容
                  icon: Image.asset(
                    "img/discover_icon_booklist.png",
                    width: 40,
                    height: 40,
                  ),
          ...
          Column(
            children: <Widget>[
              NovelFindCell(
                title: "书荒互助",
                iconName: "img/homefind_shuhuang.png",
              ),
              NovelFindCell(
                title: "有声小说",
                iconName: "img/home_find_listen.png",
              ),
              NovelFindCell(
                title: "随机看书",
                iconName: "img/home_find_lucky_game.png",
              ),
              NovelFindCell(
                title: "漫画专区",
                iconName: "img/home_find_oneyuan.png",
              ),
              NovelFindCell(
                title: "专属推荐",
                iconName: "img/home_find_migu.png",
              ),
              NovelFindCell(
                title: "游戏中心",
                iconName: "img/home_find_game_center.png",
              ),
            ],
          )
        ],
