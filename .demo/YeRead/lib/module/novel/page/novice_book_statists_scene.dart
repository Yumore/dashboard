...
class NovelBookStatistsState extends State<NovelBookStatistScene> with AutomaticKeepAliveClientMixin {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Container(height: 40, alignment: Alignment.center, padding: EdgeInsets.symmetric(horizontal: 15), child: Text("分类")),
  ...
  Widget getCateItem(BuildContext context, NovelBookStatistics item, String gender) {
    ...
    return GestureDetector(
      onTap: () {
        AppNavigator.pushNovelCategoryInfo(context, item, gender);
      },
      child: Container(
        color: TYColor.paper,
        width: width,
        child: Row(
          children: <Widget>[
            ...
            NovelCoverImage(AppUtils.showNovelCover(item.bookCover[0]), width: width / 3, height: width / 2),
          ],
        ),
      ),
    );
