...
class NovelPostPageState extends State<NovelBooklistDetailScene> with AutomaticKeepAliveClientMixin {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Container(height: 40, alignment: Alignment.center, padding: EdgeInsets.symmetric(horizontal: 15), child: Text("书单")),
        backgroundColor: TYColor.white,
        elevation: 0,
      ),
      body: Stack(
