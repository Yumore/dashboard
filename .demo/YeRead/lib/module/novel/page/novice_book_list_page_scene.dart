...
class NovelBookListPageState extends State<NovelBookListPageScene> with AutomaticKeepAliveClientMixin {
  @override
  ...
  fetchData() async {
    try {
      ...
      novelBookLists = await NovelModel.getBookList(widget.isMale, sort, tag, 0, 20);
      setState(() {
            ...
            child: Row(
              children: <Widget>[
                ...
                GestureDetector(
                  ...
                  child: Text("赛选", style: new TextStyle(color: isShowSelect ? Colors.amber : Colors.black26)),
                )
              ],
            )),
        getSelectView(),
  ...
  Widget getTypes(String title, int index) {
    ...
    return new Container(
      child: FlatButton(
        child: new Text(title, style: new TextStyle(color: isSelect ? Colors.amber : Colors.black26)),
        onPressed: () {
          setState(() {
  ...
  Widget buildChapterWidget(BuildContext context, Novelmenu chapterName, int index) {
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Text(chapterName.title, style: TextStyle(fontSize: 17, color: TYColor.gray, fontWeight: FontWeight.w500, decoration: TextDecoration.none))));
  }
