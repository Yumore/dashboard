...
class NovelBookListSceneState extends State<NovelBookListScene> with SingleTickerProviderStateMixin {
            ...
            child: Column(
              children: <Widget>[
                TabBar(
                    ...
                    labelStyle: TextStyle(fontSize: 22, color: TYColor.primary, fontWeight: FontWeight.w500),
