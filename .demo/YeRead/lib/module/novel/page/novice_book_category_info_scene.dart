...
class NovelBookCategoryInfoState extends State<NovelBookCategoryInfoScene> with AutomaticKeepAliveClientMixin {
  @override
  ...
  fetchData() async {
    try {
      novelCateInfoEntity = await NovelModel.getBookCategoriesInfo(widget.gender, widget.info.name, "", 0, 20);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Container(height: 40, alignment: Alignment.center, padding: EdgeInsets.symmetric(horizontal: 15), child: Text(widget.info.name)),
