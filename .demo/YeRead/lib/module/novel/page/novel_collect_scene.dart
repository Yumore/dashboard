...
class NovelCollectState extends State<NovelCollectScene> with AutomaticKeepAliveClientMixin {
  ...
  List<Widget> getListView() {
    ...
    var addChildrens = comicBlocks.map((comicItem) => NovelBlockItemView(comicItem, TYColor.white)).toList();
