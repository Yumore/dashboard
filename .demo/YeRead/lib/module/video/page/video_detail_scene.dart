...
class VideoDetailState extends State<VideoDetailInfoScene> with AutomaticKeepAliveClientMixin {
  ...
  _collectComic() async {
    ...
    if (_hasCollected) {
      ...
      VideoDao.addCollecte(videoDetailPage.info.title, widget.video.sId, videoDetailPage.info.cover).then((result) {
        setState(() {
          _hasCollected = true;
        });
      });
  ...
  Widget build(BuildContext context) {
    ...
    if (videoDetailPage.chapters != null && videoDetailPage.chapters.length > 0) {
