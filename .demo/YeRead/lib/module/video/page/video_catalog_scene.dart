...
class NovelBookCategoryInfoState extends State<VideoCatalogScene> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> initData() async {
    try {
      //获取关联漫画
      VideoCatalogPage pages = await VideoModel.getCatalogList(selectText, page);
