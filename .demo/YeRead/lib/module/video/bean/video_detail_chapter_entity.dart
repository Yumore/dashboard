class VideoDetailChapterEntity {
  ...
  VideoDetailChapterEntity.fromJson(Map<String, dynamic> json) {
    if (json['epranges'] != null) {
      epranges = new List<VideosEprange>();
      (json['epranges'] as List).forEach((v) {
        epranges.add(new VideosEprange.fromJson(v));
      });
    }
    if (json['ls'] != null) {
      ls = new List<VideosL>();
      (json['ls'] as List).forEach((v) {
        ls.add(new VideosL.fromJson(v));
      });
    }
    name = json['name'];
    idx = json['idx'];
