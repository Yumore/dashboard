...
class VideoInfoEntity {
  ...
  String type; //动画种类
  String cover; //图片
  VideoInfoEntity({this.title, this.time, this.sid, this.company, this.describe, this.originalTitle, this.region, this.status, this.tags, this.type, this.cover, this.writer});
