  ...
  Widget buildChapterWidget(BuildContext context, VideosL chapterName, int index) {
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Text(chapterName.name, style: TextStyle(fontSize: 17, color: TYColor.gray, fontWeight: FontWeight.w500, decoration: TextDecoration.none))));
  }

  @override
  Widget build(BuildContext context) {
    if (comicChapter == null || CollectionsUtils.isEmpty(comicChapter.ls)) {
      return Container();
    }
    ...
    return SingleChildScrollView(
        child: Column(
          children: <Widget>[
            Container(
                child: Text(comicChapter.name, style: TextStyle(fontSize: 12, color: TYColor.gray, fontWeight: FontWeight.w300, decoration: TextDecoration.none)),
