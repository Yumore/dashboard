    ...
    switch (this.widget.pageState) {
      ...
      case PageState.LoadingNetError:
        widget = GestureDetector(
            ...
            child: Container(
              color: TYColor.white,
              child: Text("加载失败，请检查网络", style: TextStyle(color: TYColor.darkGray, fontSize: 16, decoration: TextDecoration.none)),
              width: Screen.width,
      ...
      case PageState.LoadingError:
        widget = GestureDetector(
            ...
            child: Container(
              color: TYColor.white,
              child: Text("加载失败，点击重试", style: TextStyle(color: TYColor.darkGray, fontSize: 16, decoration: TextDecoration.none)),
              width: Screen.width,
              height: Screen.height,
              alignment: Alignment.center,
            ));
      ...
      case PageState.Empty:
        widget = GestureDetector(
            ...
            child: Container(
              color: TYColor.white,
              child: Text("暂无数据", style: TextStyle(color: TYColor.darkGray, fontSize: 16, decoration: TextDecoration.none)),
              width: Screen.width,
              height: Screen.height,
              alignment: Alignment.center,
            ));
