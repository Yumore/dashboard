...
class _PaintWidgetSceneState extends State<PaintWidgetScene> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Stack(alignment: Alignment.center, children: <Widget>[
          ...
          Text(
            "跳过",
            style: TextStyle(color: TYColor.primary, fontSize: 16, decoration: TextDecoration.none),
          ),
        ]),
      ),
    );
