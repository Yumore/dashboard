...
class _ScrollDemoSceneState extends State<ScrollDemoScene> {
  ...
  _getMoreData() async {
    ...
    List<int> newEntries = await fakeRequest(items.length, items.length + 10); //returns
    _pageIndex++;
    setState(() {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (index == items.length) {
                  ...
                  return Container(
                    child: Text("Number $index", style: TextStyle(fontSize: 16, color: Color(0xffe86a3e), decoration: TextDecoration.none)),
                    height: 40,
