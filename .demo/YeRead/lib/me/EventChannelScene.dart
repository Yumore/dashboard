...
class _EventChannelSceneState extends State<EventChannelScene> with TickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Stack(alignment: Alignment.center, children: <Widget>[
          Text(
            "Timer $_timer",
            style: TextStyle(color: TYColor.primary, fontSize: 30, decoration: TextDecoration.none),
          ),
        ]),
      ),
    );
