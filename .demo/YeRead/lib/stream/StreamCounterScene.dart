...
class StreamCounterScene extends StatefulWidget {
  @override
  _StreamCounterSceneState createState() => _StreamCounterSceneState(CounterStream());
}
...
class _StreamCounterSceneState extends State<StreamCounterScene> {
  ...
  void _futureDemo() {
    Future.delayed(Duration(seconds: 2), () {
      ...
      // ...
      return "number";
    }).then((val) => print('接收到数据:' + val)).whenComplete(() => print('complete')).catchError(() => print('error'));
  }
