...
class BaseAppBarWidget extends StatefulWidget {
  ...
  BaseAppBarWidget({this.title, this.barView, this.titleStyle, this.body, this.isDataReady, this.actions, this.retry});

  @override
  State<StatefulWidget> createState() => NovelPostPageState();
}

class NovelPostPageState extends State<BaseAppBarWidget> with AutomaticKeepAliveClientMixin {
  @override
