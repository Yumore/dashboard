...
class BaselistState extends State<BaseListWidget> with AutomaticKeepAliveClientMixin {
  ...
  Widget getListView() {
    ...
    if (widget.onRefresh != null) {
      return RefreshIndicator(
        ...
        child: Container(
          margin: widget.margin == null ? EdgeInsets.fromLTRB(10, 0, 0, 0) : widget.margin,
