                ...
                child: Center(
                  child: new Container(
                    ...
                    child: new Column(
                      ...
                      children: <Widget>[
                        new Container(child: SpinKitCubeGrid(color: Color(YeColors.white))),
                        new Container(height: 10.0),
                        new Container(child: new Text(CommonUtils.getLocale(context).loading_text, style: YeConstant.normalTextWhite)),
                      ],
                    ),
                  ),
                ),
