...
class VideoWidget extends StatefulWidget {
  ...
  VideoWidget(this.url, {Key key, this.previewImgUrl: '', this.showProgressBar = true, this.showProgressText = true, this.positionTag}) : super(key: key);
  ...
  getPauseView() {
    return Offstage(
      ...
      child: Stack(
        children: <Widget>[
          Align(
            child: Container(child: Image.asset('img/ic_playing.png'), height: 50, width: 50),
