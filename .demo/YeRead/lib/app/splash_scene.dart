...
class SplashSceneState extends State<SplashScene> implements OnSkipClickListener {
  @override
  void initState() {
    super.initState();
    delayedGoHomePage();
  ...
  goHomePage() {
    Navigator.of(context).pushAndRemoveUntil(CupertinoPageRoute(builder: (BuildContext context) => RootScene()), (Route<dynamic> route) => false);
  }
