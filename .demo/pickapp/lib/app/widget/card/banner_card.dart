...
class BannerCard extends StatelessWidget {
  ...
  const BannerCard(this.bannerList, {Key? key, this.bannerHeight = 160, this.padding}) : super(key: key);
  ...
  _banner() {
    ...
    return Swiper(
      ...
      //自定义指示器
      pagination:
          SwiperPagination(alignment: Alignment.bottomRight, margin: EdgeInsets.only(right: right, bottom: 10), builder: DotSwiperPaginationBuilder(color: Colors.white60, size: 6, activeSize: 12)),
    );
  }
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: InkWell(
          ...
          child: Stack(
            children: [
              cachedImage(bannerList.cover, width: setWidth(1050), height: bannerHeight),
              Positioned(
                  left: 0,
                  bottom: 0,
                  right: 0,
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: setWidth(600),
                          child: Text(
                            bannerList.postType == "dynamic" ? bannerList.content : bannerList.title,
                            maxLines: 1,
