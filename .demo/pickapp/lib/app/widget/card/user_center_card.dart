...
class UserCenterCard extends StatelessWidget {
  ...
  const UserCenterCard({Key? key, required this.contentModel}) : super(key: key);
  ...
  _itemImage(BuildContext context) {
    return Stack(
      children: [
        cachedImage(contentModel.cover, width: Get.size.width / 2 - 22, height: 100),
        Positioned(
            left: 0,
            bottom: 0,
            right: 0,
  ...
  _infoText(Color textColor) {
    return Expanded(
        child: Container(
      padding: EdgeInsets.only(top: setHeight(20), left: setWidth(20), right: setHeight(20), bottom: setHeight(20)),
      child: Text(
