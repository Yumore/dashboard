...
class RankingLargeCard extends StatelessWidget {
  ...
  const RankingLargeCard({Key? key, required this.contentModel}) : super(key: key);
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(left: setWidth(30), right: setWidth(10), bottom: setHeight(20), top: setHeight(20)),
          child: Row(
  ...
  _itemImage(BuildContext context) {
    return ClipRRect(
      ...
      child: Stack(
        children: [
          cachedImage(contentModel.cover, width: setWidth(460), height: setHeight(260)),
          Positioned(
              bottom: 5,
              right: 5,
              child: Container(
                ...
                child: Text(
                  formatDate(DateTime.parse("${contentModel.createTime.substring(0, 19)}")),
  ...
  _buildContent(context) {
    return Expanded(
        child: Container(
      padding: EdgeInsets.only(left: 8, bottom: setHeight(12), top: setHeight(10)),
      child: Column(
        ...
        children: [
          Container(
            width: setWidth(500),
            child: Text(
              contentModel.postType == "dynamic" ? contentModel.content : contentModel.title,
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(height: 1.3, color: Color.fromRGBO(33, 35, 37, 1), fontSize: setSp(35), fontWeight: FontWeight.w500),
            ),
          ),
    ...
    return Row(
      children: [
        Container(
          ...
          child: Text(
            "UP",
            style: TextStyle(color: Colors.grey, fontSize: setSp(24), fontWeight: FontWeight.bold),
          ),
        ),
        hiSpace(width: 4),
        Text(
