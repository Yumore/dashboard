    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Column(
          children: [
            Container(
              margin: EdgeInsets.only(top: setHeight(38), bottom: setHeight(20), left: setWidth(30), right: setWidth(30)),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
                    margin: EdgeInsets.only(right: setWidth(30)),
                    decoration: BoxDecoration(border: Border.all(width: 1, color: Colors.grey[300]!), borderRadius: BorderRadius.circular(setRadius(115))),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(setRadius(115)),
                      child: cachedImage(contentModel.userMeta.avatar, height: setR(115), width: setR(115)),
                    ),
                  ),
                  Expanded(
                      child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(color: primary, fontSize: setSp(40), fontWeight: FontWeight.w800),
                      ),
                      hiSpace(height: setHeight(10)),
                      Text(
                        "${formatDate(DateTime.parse("${contentModel.createTime.substring(0, 19)}"))} · 进行了投稿",
                        style: TextStyle(color: Colors.grey, fontSize: setSp(30)),
                      )
                    ],
                  )),
                  Container(
            ...
            contentModel.postType == "dynamic" || contentModel.postType == "video"
                ? Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontSize: setSp(45), fontWeight: FontWeight.w400, color: Color.fromRGBO(83, 83, 83, 1)),
                    ),
                  )
                : Container(),
            ClipRRect(
              borderRadius: BorderRadius.circular(5),
              child: cachedImage(contentModel.cover, width: Get.width - 20, height: 200),
            ),
            contentModel.postType == "post" || contentModel.postType == "video"
                ? Container(
                    alignment: Alignment.centerLeft,
                    margin: EdgeInsets.only(top: setHeight(20), bottom: setHeight(20), left: setWidth(40), right: setWidth(40)),
                    child: Text(
                      contentModel.title,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(fontSize: setSp(40), fontWeight: FontWeight.w700),
                    ),
                  )
                : Container(),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _synamicIcon("assets/icon/star.png", "${contentModel.likes}", () {}),
                ],
              ),
            )
          ],
      ...
      child: InkResponse(
        ...
        child: Row(
          children: [
            ...
            Text(
              name,
              style: TextStyle(fontSize: setSp(35), color: Color.fromRGBO(148, 151, 156, 1)),
            )
          ],
        ),
      ),
