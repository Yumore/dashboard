...
import 'package:pink_acg/app/lib/fijkplayer_skin/schema.dart' show VideoSourceFormat;
...
class VideoScreen extends StatefulWidget {
  ...
  const VideoScreen({Key? key, required this.url, required this.title, required this.curTabIdx, required this.curActiveIdx, required this.player, this.videoSourceTabs}) : super(key: key);
...
class _VideoScreenState extends State<VideoScreen> {
  ...
  Widget build(BuildContext context) {
    return widget.url != {} && widget.url != null && widget.videoSourceTabs != null
        ? Container(
            height: setR(620),
