...
class VideoHeader extends StatelessWidget {
  ...
  const VideoHeader({Key? key, this.userMeta, required this.time, required this.isFollow, required this.isSelf, required this.onFollow}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      color: Colors.white,
      padding: EdgeInsets.only(top: setHeight(5), right: setWidth(30), left: setWidth(30)),
      child: Row(
            ...
            child: Row(
              ...
              children: [
                ClipRRect(
                  ...
                  child: cachedImage(userMeta!.avatar, height: setR(90), width: setR(90)),
                ),
