...
class _VideoContentState extends State<VideoContent> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [_buildTitle(), hiSpace(height: setHeight(15)), _buildInfo(), _buildDes()],
      ),
    );
  }
  ...
  _buildInfo() {
    ...
    var dataStr = widget.mo.createTime.length > 10 ? widget.mo.createTime.substring(5, 10) : widget.mo.createTime;
    return Row(
      children: [
