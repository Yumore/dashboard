            ...
            Container(
              ...
              child: TextButton(
                ...
                style: ButtonStyle(
                  ...
                  textStyle: MaterialStateProperty.all(TextStyle(fontSize: setSp(38), color: Colors.white)),
                  //更优美的方式来设置
  ...
  _input() {
    return Expanded(
      child: TextField(
        ...
        //输入框样式
        decoration: InputDecoration(contentPadding: EdgeInsets.only(left: 20, right: 20), border: InputBorder.none, hintText: widget.hint, hintStyle: TextStyle(fontSize: 15)),
      ),
    );
  }
}
