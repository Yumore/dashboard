        ...
        children: [
          Container(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    padding: EdgeInsets.only(bottom: setHeight(28), top: setHeight(14), left: setWidth(20), right: setWidth(20)),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        textBtn(iconShare("微信", "assets/icon/wechat.png"), () async {
                          showWarnToast("暂不支持");
                          Navigator.of(context).pop();
                        }),
                        textBtn(iconShare("朋友圈", "assets/icon/friends.png"), () async {
                          showWarnToast("暂不支持");
                          Navigator.of(context).pop();
                        }),
                        ...
                        //   Navigator.of(context).pop();
                        // }),
                        textBtn(iconShare("QQ空间", "assets/icon/qzone.png"), () async {
                          showWarnToast("暂不支持");
                          Navigator.of(context).pop();
                        }),
              ...
              children: [
                textBtn(iconShare("稍后再看", "assets/icon/play_await.png"), () {
                  ...
                  if (awaitWatch != null && awaitWatch.length > 0) {
                    ...
                    GetStorage().write("awaitWatchPost", ["${widget.postMo.postId}"]);
                  }
                  showToast("添加成功");
                  Navigator.of(context).pop();
                }),
          ...
          Container(
              ...
              padding: EdgeInsets.only(bottom: setHeight(48), top: setHeight(48)),
              child: textBtn(
                  Text(
                    "取消",
                    textAlign: TextAlign.center,
                    style: TextStyle(decoration: TextDecoration.none, fontSize: setSp(40), color: Colors.black, fontWeight: FontWeight.w500),
                  ), () {
                Navigator.of(context).pop();
              })),
        ],
