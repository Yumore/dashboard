...
class CommentTabPage extends StatefulWidget {
  ...
  const CommentTabPage({Key? key, required this.postId, this.refresh = true, required this.content}) : super(key: key);

  @override
  _CommentTabPageState createState() => _CommentTabPageState();
}

class _CommentTabPageState extends PinkBaseTabState<CommentMo, CommentList, CommentTabPage> {
  @override
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                "按热度",
                style: TextStyle(fontSize: setSp(38), color: Color.fromRGBO(146, 156, 149, 1)),
              )
            ],
          )
        ],
      ),
      padding: EdgeInsets.only(top: setHeight(30), left: setWidth(30), right: setWidth(25), bottom: setHeight(20)),
    );
  }
  ...
  commentCard(index) {
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          padding: EdgeInsets.only(left: setWidth(30), right: setWidth(30), top: setHeight(30), bottom: setHeight(30)),
          child: Column(
            children: [
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(height: 1, fontWeight: FontWeight.w800, color: Colors.black54, fontSize: setSp(34)),
                      ),
              ...
              Container(
                margin: EdgeInsets.only(left: setWidth(105), top: setHeight(30)),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Row(
                      children: [
                        Image.asset("assets/icon/comment_like.png", width: setWidth(60), height: setHeight(60), color: Colors.black),
                        hiSpace(width: setWidth(30)),
                        Image.asset("assets/icon/comment_unlike.png", width: setWidth(60), height: setHeight(60), color: Colors.black),
                        hiSpace(width: setWidth(30)),
                        Image.asset("assets/icon/comment_icon.png", width: setWidth(60), height: setHeight(60), color: Colors.black),
                      ],
                    ),
                  ],
                ),
