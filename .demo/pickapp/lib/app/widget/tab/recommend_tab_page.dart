...
class RecommendTabPage extends StatefulWidget {
  ...
  const RecommendTabPage({Key? key, this.categoryId = 0, this.bannerList}) : super(key: key);

  @override
  _RecommendTabPageState createState() => _RecommendTabPageState();
}

class _RecommendTabPageState extends PinkBaseTabState<RecommendMo, PostMo, RecommendTabPage> {
  @override
  void initState() {
