...
class SearchTabPage extends StatefulWidget {
  ...
  const SearchTabPage({Key? key, required this.type, required this.word}) : super(key: key);

  @override
  SearchTabPageState createState() => SearchTabPageState();
}

class SearchTabPageState extends PinkBaseTabState<SearchPostMo, PostMo, SearchTabPage> {
  String word = "";
  ...
  Future<SearchPostMo> getData(int pageIndex) async {
    SearchPostMo result = await SearchDao.get(widget.type, word, page: pageIndex, size: 20);
    return result;
  }
