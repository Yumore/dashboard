...
class _RankingTabPageState extends PinkBaseTabState<RankingMo, PostMo, RankingTabPage> {
  @override
      ...
      ? ListView(
          ...
          children: [
            GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 1, childAspectRatio: setHeight(1080) / setWidth(310)),
                padding: EdgeInsets.only(top: 10),
                itemBuilder: (BuildContext context, int index) => RankingLargeCard(contentModel: dataList[index])),
