...
class UserCenterController extends GetxController with SingleGetTickerProviderMixin {
  ...
  Future<void> loadUserCenter() async {
    try {
      UserCenterMo result = await UserCenterDao.get(profileMo.value.userId.toString());
  ...
  void onInit() {
    ...
    controller.addListener(() {
      if (controller.position.pixels > setHeight(200) + headerHight && !showBarColor.value) {
