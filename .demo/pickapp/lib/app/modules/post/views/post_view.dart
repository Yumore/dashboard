...
class PostView extends GetView<PostController> {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: FlexibleSpaceBar(
          ...
          background: Container(height: setHeight(548), width: Get.width, color: Colors.grey, child: Obx(() => cachedImage(controller.contentModel.value.cover))),
        ),
      ),
      leading: Obx(() => userCenterIcon(controller.showBarColor.value, Icons.arrow_back, () {
            Get.back();
          })),
      actions: <Widget>[
        Obx(() => userCenterIcon(controller.showBarColor.value, Icons.more_horiz, () {
              moreHandleDialog(context, 720, ShareCard(postMo: controller.contentModel.value));
            })),
      ],
    );
  }
            ...
            children: [
              Obx(() => controller.contentModel.value.postType == "post"
                  ? Container(
                      ...
                      child: Text(
                        controller.contentModel.value.title,
                        style: TextStyle(height: 1.2, fontSize: setSp(65), fontWeight: FontWeight.w600),
                      ),
                    )
                  : Container()),
              Container(
                margin: EdgeInsets.only(left: setWidth(20), right: setWidth(20), top: setHeight(40), bottom: setHeight(0)),
                  ...
                  ? Container(
                      ...
                      child: Html(
                          ...
                          onImageTap: (String? url, RenderContext context, Map<String, String> attributes, dom.Element? element) {
                            Get.toNamed("/photo-dia", parameters: {"image": url!});
                          }),
                    )
                  : Container(
                      alignment: Alignment.centerLeft,
                        ...
                        RepaintBoundary(
                          ...
                          child: Container(
                            ...
                            child: Obx(() => QrImage(
                                  ...
                                  size: 320,
                                  gapless: false,
                                  embeddedImage: NetworkImage(PinkConstants.ossDomain + '/' + controller.contentModel.value.cover),
              ...
              Container(
                padding: EdgeInsets.only(left: setWidth(35), right: setWidth(35), top: setHeight(20), bottom: setHeight(30)),
                child: Row(
    ...
    return SliverPersistentHeader(
      ...
      delegate: StickyTabBarDelegate(
        child: TabBar(
          ...
          indicator: UnderlineIndicator(strokeCap: StrokeCap.square, borderSide: BorderSide(color: primary, width: setHeight(6)), insets: EdgeInsets.only(left: setWidth(40), right: setWidth(40))),
  ...
  Widget _buildInput() {
    return Expanded(
      ...
      decoration: BoxDecoration(color: Colors.grey[200], borderRadius: BorderRadius.circular(26)),
      child: TextField(
        autofocus: true,
  ...
  Widget _buildSendBtn() {
    return InkWell(
      onTap: () {
        var text = controller.textEditingController.text.isNotEmpty ? controller.textEditingController.text.trim() : "";
          ...
          child: Row(
            children: [
              Expanded(
                ...
                height: setHeight(86),
                width: setWidth(300),
                margin: EdgeInsets.only(left: setWidth(40), right: setWidth(40)),
                child: InkWell(
                  onTap: () {
                    showCommentDialog();
                  },
              ...
              Container(
                  ...
                  child: Obx(() => InkWell(
                        onTap: () {
                          onFavorite(controller.contentDetailModel.value.isFavorite, controller.contentModel.value.postId, () {
                            if (controller.contentDetailModel.value.isFavorite) {
                              controller.contentDetailModel.update((val) {
                        ...
                        child: Icon(
                          ...
                          size: 22,
                          color: controller.contentDetailModel.value.isFavorite ? primary : Color.fromRGBO(117, 117, 117, 1),
                        ),
                      ))),
              Container(
                  padding: EdgeInsets.only(right: 12, left: 12),
                  child: InkWell(
                    onTap: () {
                      moreHandleDialog(context, 720, Obx(() => ShareCard(postMo: controller.contentModel.value)));
                    },
                    child: Image.asset(
              ...
              Container(
                  ...
                  child: Obx(() => InkWell(
                        ...
                        child: Image.asset(
                          ...
                          width: setWidth(55),
                          color: controller.contentDetailModel.value.isLike ? primary : Color.fromRGBO(117, 117, 117, 1),
                        ),
                      )))
            ],
          ),
