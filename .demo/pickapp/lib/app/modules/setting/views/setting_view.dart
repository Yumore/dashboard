...
class SettingView extends GetView<SettingController> {
              ...
              children: [
                ...
                Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(alignment: Alignment.centerLeft, padding: EdgeInsets.only(left: 40, top: 15, bottom: 15), child: Text(controller.items[index]["name"] as String)),
                  ),
                ),
                Divider(
                  height: 0.2,
  ...
  Widget _footer() {
    return Container(
      decoration: BoxDecoration(border: Border(top: BorderSide(width: 0.4, color: Color.fromRGBO(236, 236, 236, 1)), bottom: BorderSide(width: 0.4, color: Color.fromRGBO(236, 236, 236, 1)))),
      child: Material(
        color: Colors.white,
        child: InkWell(
          onTap: () {
