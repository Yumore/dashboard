...
class SearchView extends GetView<SearchController> {
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          Obx(() => controller.hasInput.value ? searchHistory(context) : searchResult())
        ],
      ),
    );
  }
              ...
              child: Container(
                ...
                child: Obx(() => TextField(
                      ...
                      controller: TextEditingController.fromValue(TextEditingValue(
                          ...
                          // 保持光标在最后
                          selection: TextSelection.fromPosition(TextPosition(affinity: TextAffinity.upstream, offset: controller.searchWord.value.length)))),
                      onTap: () {
                        controller.allSearchHistorys.value = GetStorage().read("searchHistory")!;
                      ...
                      onChanged: (value) {},
                      style: TextStyle(fontSize: setSp(46), color: Color.fromRGBO(80, 80, 80, 1)),
                      decoration: InputDecoration(
                          hintText: "动漫游戏galgame",
                          hintStyle: TextStyle(fontSize: setSp(36), color: Color.fromRGBO(190, 190, 190, 1)),
                          icon: Container(
                            width: setWidth(10),
                            child: Icon(
                              Icons.search,
  ...
  Widget searchHisBtn(String name) {
    return Container(
      ...
      child: InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(color: Color.fromRGBO(238, 240, 240, 1), borderRadius: BorderRadius.circular(setRadius(10))),
          padding: EdgeInsets.only(left: setWidth(40), top: setHeight(12), right: setWidth(40), bottom: setHeight(12)),
          child: Text(
            "$name",
  ...
  Widget searchHistory(context) {
    return Expanded(
        child: Container(
      padding: EdgeInsets.only(left: setWidth(34), right: setWidth(34), top: setHeight(12), bottom: setHeight(30)),
      child: MediaQuery.removePadding(
          ...
          child: ListView(
            ...
            children: [
              Text(
                "热搜",
                style: TextStyle(color: Colors.black, fontSize: setSp(38), fontWeight: FontWeight.w600),
              ),
              Container(
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Container(
                            ...
                            child: InkWell(
                              onTap: () {
                                controller.setSearchHistory(controller.dataList[index]);
                                controller.searchWord.value = controller.dataList[index];
                              },
                              child: Text(
                                "${index + 1}.  ${controller.dataList[index]}",
                                style: TextStyle(height: setHeight(4), fontSize: setSp(38), fontWeight: FontWeight.w400),
                              ),
                            ));
                      }),
                  context: context,
              ...
              controller.allSearchHistorys.value != null && controller.allSearchHistorys.value.isNotEmpty
                  ? Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Wrap(
                            ...
                            children: controller.allSearchHistorys.value.map((value) {
                                  ...
                                  cancel: Container(
                                    ...
                                    child: ClipRRect(
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(
                                              color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(setRadius(30))), border: Border.all(width: setWidth(5), color: primary)),
                                  ...
                                  confirm: Container(
                                    ...
                                    child: ClipRRect(
                                      child: InkWell(
                                        ...
                                        onTap: () {
                                          GetStorage().write("searchHistory", []);
                                          controller.allSearchHistorys.value = GetStorage().read("searchHistory")!;
                                          showToast("删除成功");
                                          Get.back();
                                        },
