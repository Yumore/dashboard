...
class WebsocketController extends GetxController {
  ...
  open() {
    _channel = IOWebSocketChannel.connect(url, headers: {PinkConstants.authorization: "Bearer " + LoginDao.getBoardingPass()}, pingInterval: Duration(seconds: _intervalSeconds));
