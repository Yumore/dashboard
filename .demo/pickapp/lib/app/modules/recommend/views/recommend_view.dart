...
class RecommendView extends GetView<RecommendController> {
      ...
      child: Row(
        children: [
          Container(
            ...
            child: InkWell(
              ...
              child: ClipRRect(
                ...
                child: cachedImage(controller.avatar.value, width: setR(100), height: setR(100)),
              ),
            ),
          ),
          Container(
          ...
          Container(
            ...
            child: InkWell(
              onTap: () {
                Get.toNamed("/web-browser", parameters: {"url": "https://baidu.com"});
              },
              child: ClipRRect(
                borderRadius: BorderRadius.circular(setRadius(86)),
                child: cachedImage(controller.avatar.value, width: setR(86), height: setR(86)),
              ),
            ),
          ),
  ...
  Widget _updateApp() {
    return Obx(() => (controller.Update.value && GetStorage().read("update_time") == null) || (controller.Update.value && GetStorage().read("update_time") < DateTime.now().millisecondsSinceEpoch)
        ? Update(
            ...
            close: () {
              ...
              GetStorage().write("update_time", DateTime.now().millisecondsSinceEpoch + 86400000);
            },
            update: () async {
              controller.Update.value = false;
              await RUpgrade.upgrade(controller.serverAndroidUrl, fileName: 'app-release.apk', isAutoRequestInstall: true);
            },
          )
        : Container());
  }
