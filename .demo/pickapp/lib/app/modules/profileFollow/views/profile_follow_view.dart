            ...
            child: MediaQuery.removePadding(
                ...
                child: controller.fansListMo.isNotEmpty
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) => _userMetaItem(controller.fansListMo[index].userMeta, index: index))
                    : ListView.builder(
                        physics: AlwaysScrollableScrollPhysics(),
  ...
  _userMetaItem(userMeta, {index}) {
    return Column(
      children: [
        Container(
          color: Colors.white,
          padding: EdgeInsets.only(top: setWidth(22), bottom: setWidth(22), right: setWidth(30), left: setWidth(30)),
          child: Row(
                ...
                child: Row(
                  children: [
                    ClipRRect(
                      ...
                      child: cachedImage(userMeta.avatar, height: setR(150), width: setR(150)),
                    ),
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            userMeta.username,
                            style: TextStyle(fontSize: setSp(38), color: primary, fontWeight: FontWeight.bold),
                          ),
                          hiSpace(height: setHeight(10)),
                          Text(
                            userMeta.descr != "" ? userMeta.descr : "这个人很懒，什么都没写!",
                  ...
                  ? followBtn(
                      ...
                      !controller.fansListMo[index].isFollow
                          ? () {
                              ...
                              controller.fansListMo[index].isFollow = !controller.fansListMo[index].isFollow;
                            }
                          : () {
