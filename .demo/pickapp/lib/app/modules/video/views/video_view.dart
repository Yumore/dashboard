...
class VideoView extends GetView<VideoController> {
    ...
    return Expanded(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          isDense: true,
          contentPadding: EdgeInsets.only(left: setWidth(40), right: setWidth(40), top: setHeight(25), bottom: setHeight(25)),
    ...
    return ListView(
      ...
      children: [
        ...
        VideoToolBar(
          ...
          onFavorite: () {
            onFavorite(controller.videoDetailMo.value.isFavorite, controller.contentModel.value.postId, () {
        ...
        Container(
          ...
          padding: EdgeInsets.only(left: setWidth(20), right: setWidth(20), top: setHeight(35), bottom: setHeight(35)),
                      ...
                      child: TextButton(
                        style: ButtonStyle(
                          ...
                          side: MaterialStateProperty.all(
                              BorderSide(color: controller.curTabIdx == 0 && controller.curActiveIdx == e.key ? primary : Color.fromRGBO(236, 236, 236, 1), width: setWidth(3))),
                        ),
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(fontSize: setSp(32), color: controller.curTabIdx == 0 && controller.curActiveIdx == e.key ? primary : Colors.black),
                          ),
                        ),
                        onPressed: () async {
                          ...
                          controller.player.update((val) {
                            val!.setDataSource(controller.contentModel.value.video.video[controller.curTabIdx.value].list[controller.curActiveIdx.value].url, autoPlay: true);
                          });
                        },
                      ),
                    );
  ...
  _buildVideoList(context) {
    return controller.videoList.map(
      (PostMo mo) => VideoLargeCard(player: controller.player.value, contentModel: mo),
    );
  }
