...
abstract class PinkBaseTabState<M, L, T extends StatefulWidget> extends State<T> with AutomaticKeepAliveClientMixin {
  List items = [
    {"name": "随机排序", "key": "rand"},
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      ...
      //距离不足0时加载更多
      if (dis == 0 && !loading && scrollController.position.maxScrollExtent != 0) {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: openRefresh
          ...
          : MediaQuery.removePadding(removeTop: true, context: context, child: contentChild),
    );
  }
