...
class LogDao {
  static post(dynamic param, {required String readTime, required int categoryId}) async {
    LogRequest request = LogRequest();
    request.add("param", jsonEncode(param)).add("readTime", readTime).add("categoryId", categoryId);
