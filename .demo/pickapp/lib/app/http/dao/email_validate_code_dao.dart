...
class ForgetPwdEmailValidateCodeDao {
  static get(String email) async {
    ForgetPwdEmailValidateCodeRequest request = ForgetPwdEmailValidateCodeRequest();
    request.add("email", email);
    var result = await PinkNet.getInstance().fire(request);
    return result;
  }
...
class ChangePwdEmailValidateCodeDao {
  static get(String email) async {
    ChangePwdEmailValidateCodeRequest request = ChangePwdEmailValidateCodeRequest();
    request.add("email", email);
    var result = await PinkNet.getInstance().fire(request);
    return result;
  }
