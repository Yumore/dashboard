...
class PostMo {
  ...
  PostMo.fromJson(Map<String, dynamic> json) {
    userMeta = (json['owner'] != null ? UserMeta.fromJson(json['owner']) : null)!;
    postId = json['post_id'];
    ...
    view = json['view'];
    cover = json['cover'];
    video = (json['video'] != null ? Collection.fromJson(jsonDecode(json['video'])) : null)!;
    download = json['download'];
    recoPost = json['reco_post'] != null ? RecoPost.fromJson(json['reco_post']) : null;
