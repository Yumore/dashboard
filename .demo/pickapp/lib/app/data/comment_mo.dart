...
class CommentList {
  ...
  CommentList({required this.owner, required this.postId, required this.userId, required this.content, required this.type, required this.parent, required this.likeNum, required this.updatedTime});
