...
class ContactList {
  ...
  ContactList({this.userId = 0, this.sendId = 0, this.sendUserMeta, this.chatMo, this.updateTime = ""});

  ContactList.fromJson(Map<String, dynamic> json) {
    userId = json['user_id'];
    sendId = json['send_id'];
    sendUserMeta = (json['send_user_meta'] != null ? new UserMeta.fromJson(json['send_user_meta']) : null)!;
