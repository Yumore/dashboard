...
class VideoDetailMo {
  ...
  VideoDetailMo({this.isFavorite = false, this.isSelf = false, this.isFollow = false, this.isCoin = false, this.isLike = false, this.isUnLike = false, this.postInfo, this.postList});
  ...
  VideoDetailMo.fromJson(Map<String, dynamic> json) {
    ...
    postInfo = (json['postInfo'] != null ? PostMo.fromJson(json['postInfo']) : null)!;
