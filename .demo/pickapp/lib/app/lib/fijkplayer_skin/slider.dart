...
class NewFijkSliderColors {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NewFijkSliderColors && runtimeType == other.runtimeType && hashCode == other.hashCode;
...
class _SliderPainter extends CustomPainter {
  ...
  _SliderPainter(this.v, this.cv, this.dragging, {this.colors = const NewFijkSliderColors()});
