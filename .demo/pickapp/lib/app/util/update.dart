...
class UpdateUtil {
  ...
  static Future<Map> getUpgrade() async {
    if (Platform.isAndroid) {
      ...
      var result = await Dio().get("http://" + PinkConstants.domain + ":8080/api/v1/update");
      if (result.data != "") {
        ...
        if (c == 1) {
          return {"update": true, "msg": serverAndroidMsg, "version": serverAndroidVersion, "url": serverAndroidUrl};
        }
      }
    }
    return {
  ...
  Future<void> showUpdate(BuildContext context, String serverAndroidVersion, String serverAndroidMsg, String serverAndroidUrl) {
  ...
  void doUpdate(BuildContext context, String serverAndroidVersion, String serverAndroidUrl) async {
