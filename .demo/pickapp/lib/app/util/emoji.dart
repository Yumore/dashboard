...
class EmojiExpression extends StatelessWidget {
  ...
  EmojiExpression(this._callClick, {this.crossAxisCount = 8, this.mainAxisSpacing = 2.0, this.crossAxisSpacing = 2.0, this.childAspectRatio = 1.0, this.bigSizeRatio = 8.0});
...
class ExpressionText extends StatelessWidget {
  ...
  const ExpressionText(this._text, this._textStyle, {Key? key, this.maxLine = -1}) : super(key: key);
