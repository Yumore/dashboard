...
class ReaderSceneState extends State<ReaderScene> with RouteAware {
  ...
  void setup() async {
    ...
    topSafeHeight = ScreenUtils.topSafeHeight;
  ...
  onScroll() {
    var page = pageController.offset / ScreenUtils.width;
  ...
  Future<Article> fetchArticle(int articleId) async {
    ...
    var contentHeight = ScreenUtils.height - topSafeHeight - ReaderUtils.topOffset - ScreenUtils.bottomSafeHeight - ReaderUtils.bottomOffset - 20;
    var contentWidth = ScreenUtils.width - 15 - 10;
  ...
  onTap(Offset position) async {
    double xRate = position.dx / ScreenUtils.width;
